...
class cfgVehicles
{
	...
	class shirt_hobbit : shirt_eutyches {
		scope = 2;
		visibilityModifier = 0.95;
		hiddenSelectionsTextures[] = {"eutyches-shirts\tshirt_hobbit_co.paa", "eutyches-shirts\tshirt_hobbit_co.paa", "eutyches-shirts\tshirt_hobbit_co.paa"};
	};
	class shirt_rush : shirt_eutyches {
		scope = 2;
		visibilityModifier = 0.95;
		hiddenSelectionsTextures[] = {"eutyches-shirts\tshirt_rush_co.paa", "eutyches-shirts\tshirt_rush_co.paa", "eutyches-shirts\tshirt_rush_co.paa"};
	};
	class shirt_marquette : shirt_eutyches {
		scope = 2;
		visibilityModifier = 0.95;
		hiddenSelectionsTextures[] = {"eutyches-shirts\tshirt_marquette_co.paa", "eutyches-shirts\tshirt_marquette_co.paa", "eutyches-shirts\tshirt_marquette_co.paa"};
	};
	class shirt_atc : shirt_eutyches {
		scope = 2;
		visibilityModifier = 0.95;
		hiddenSelectionsTextures[] = {"eutyches-shirts\tshirt_atc_co.paa", "eutyches-shirts\tshirt_atc_co.paa", "eutyches-shirts\tshirt_atc_co.paa"};
	};
	class shirt_fssp : shirt_eutyches {
		scope = 2;
		visibilityModifier = 0.95;
		hiddenSelectionsTextures[] = {"eutyches-shirts\tshirt_fssp_co.paa", "eutyches-shirts\tshirt_fssp_co.paa", "eutyches-shirts\tshirt_fssp_co.paa"};
	};
};
